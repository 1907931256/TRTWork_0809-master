...
namespace Communication
{
    ...
    class SerialPortWrapper
    {
        ...
        private void DataReceivedHandler(Object sender, SerialDataReceivedEventArgs e)
        {
            ...
            int count_S = serialPort_.Read(readBuffer_, 0, BUFFER_SIZE);//读取串口里面全部内容

            Log.Debug("DataReceivedHandler start Test " + count_S);
            Log.Debug("DataReceivedHandler data = " + ByteArrayToHexString(readBuffer_, 0, count_S));
