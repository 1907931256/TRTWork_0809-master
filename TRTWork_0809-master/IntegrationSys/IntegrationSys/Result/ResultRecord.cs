...
namespace IntegrationSys.Result
{
    class ResultRecord
    {
        ...
        public static void Load(string sn)
        {
            ...
            {
#if home
                  string filename = @"e:\DataFragment\" + sn + "_" + i;
#else
        ...
        public static void Record(string sn)
        {
            ...
            {
#if home
                string filename = @"e:\DataFragment\" + sn + "_" + NetUtil.GetStationIndex();//家里调试
#else
                  string filename = @"d:\DataFragment\" + sn + "_" + NetUtil.GetStationIndex();//正常情况
#endif
