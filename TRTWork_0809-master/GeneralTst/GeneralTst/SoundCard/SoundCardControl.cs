...
namespace GeneralTst.SoundCard
{
    class SoundCardControl
    {
		...
		private Microsoft.DirectX.DirectSound.Capture capture_;
		...
		private WaveFormat CreateWaveFormat()
		{
            ...
            result.AverageBytesPerSecond = (int)result.Channels * result.BitsPerSample / 8 * result.SamplesPerSecond;
			return result;
		}
