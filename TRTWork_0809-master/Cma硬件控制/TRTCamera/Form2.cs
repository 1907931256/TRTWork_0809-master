...
namespace TRTCamera
{
    public partial class Form2 : Form
    {
        ...
        private static void PortDo(out string protName)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                pram = "FF";
                //sendCmdHex="72 05 C1 04 01 FF 81";
            }
            else if (comboBox3.Text == "绿灯")
            {
                //sendCmdHex="72 05 C1 04 01 00 81";
                pram = "00";
            }
            else
            {
                pram = "AA";
                //sendCmdHex = "72 05 C1 04 01 AA 81";
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            trackBar3.Value = Convert.ToInt32(comboBox4.Text);
        }
        ...
        //    string str = string.Empty;
        //    string pram = string.Empty;
        //    if (comboBox5.Text=="向上运动")
        //    {
        //      pram="00 "+ ShujuChuli.INT32ToFourString(Convert.ToInt32(textBox1.Text));
        //    }
        //    commProtHelp_.SendCmd(button5.Text,pram, out str);
        //}
